            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="task-4">
                        <div class="question">
                            <br>
                            <h5>4. make a login form, with username and password. Now take variable in action file where store username and password hard coded. Now when the form submits with username and password then check with the values that taken with variable. If username and password match, then show "Authorized" otherwise show "Invalid Credentials"
                                <ol class="ms-5 mt-3 list-group list-group-numbered">
                                    <li class="list-group-item d-inline">Take a form with file input field. Now upload a file and store in image folder</li>
                                    <li class="list-group-item d-inline">Take a form with file input field. Now when upload an image check if the file size is not more than 2 MB. If the file is more than 2 MB then show message that can not be uploaded</li>
                                </ol>
                            </h5>
                        </div>
                        <form action="" method="post">
                        ...
                        <div class="result">
                            ...
                            <h3 class="fw-bold text-bg-warning p-2 rounded">RESULT</h3>
                            <div class="p-2 text-bg-light rounded">
                                <h3> USER Credentials : <?php
                                                        if ($AuthorisedEntry == 1) {
                                                            echo "Authorized User Input";
                                                        } else {
